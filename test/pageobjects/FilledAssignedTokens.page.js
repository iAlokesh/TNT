...
class FilledAssignedTokensPage {

    //Web Locators

    get heading(){
        return $("(//h3[normalize-space()='FILLED ASSIGNED TOKENS'])[1]") //xpath for heading 
    }
    ...
    /*
    This method is to validate the heading of the filled assigned tokens page

    @param ValidationMessage - message which needs to be validated should be passed
    */
    async checkHeading(validationMessage){

        await expect(this.heading).toHaveTextContaining(validationMessage) //validating the validation message for check the heading of the filled assigned tokens page
        
        report.addStep("Validate the heading of the filled assigned tokens page",await browser.takeScreenshot(),"passed")
    }
...
module.exports = new FilledAssignedTokensPage() //This is for exporting the instance of FilledAssignedTokensPage class