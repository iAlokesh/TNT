...
class DistributorPage{
    ...
    get addNewDistributorsPopUpHeading(){
    ...
    */
    ...
    /*
    This method is for clicking on add new button and validate Add New Distributor pop up heading
    */
    async AddNew(){
        ...
        await expect(this.addNewDistributorsPopUpHeading).toHaveTextContaining('Add New Distributor')
